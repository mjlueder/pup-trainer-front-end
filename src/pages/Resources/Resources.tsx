    ...
    <main className={styles.content} >
      ...
      <div className={styles.resources}>
        <div className={styles.card}>
          ...
          <p>A brief beginner's guide to understanding dog training resources and methods, including tips for identifying effective and humane techniques and potential red flags to watch out for.</p>
          <br />
        ...
        <p>Karen Overall's protocols for behavior modification look intimidating, but they're not hard to understand once you get into them. These are fantastic documents. There are many good resources on the site. The following two are great foundational guidelines for overall behavior improvment.</p>
        ...
        <p>This is a public facebook group, so take it with a grain of salt and an eye towards evaluating safety, but people share some great and creative ideas here</p>
