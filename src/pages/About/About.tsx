    ...
    <main className={styles.container}>
      <h1 className={styles.title}>About Pup Trainer</h1>
        <div className={styles.images}>
          ...
          {/* <img src="https://res.cloudinary.com/dmxca77ml/image/upload/v1677531178/m19qbairsybizoghegfh.jpg" alt="Teddy the destroyer (dog)" className={styles.img} />
          <img src="https://res.cloudinary.com/dmxca77ml/image/upload/v1677530274/gahpbezc936unkk76jsw.jpg" alt="Teddy the destroyer (dog)" className={styles.img} />
          <img src="https://res.cloudinary.com/dmxca77ml/image/upload/v1677531245/as6yurp2med2y6xd6rvx.jpg" alt="Teddy the destroyer (dog)" className={styles.img} /> */}
        </div>
        <div>
          <h4>
          ...
          <h4>
            Training your dog is not only fun but also essential for their well-being and the overall happiness of your household. With Pup Trainer, you can skip the frustrating and time-consuming search for quality training resources and dive straight into the fun of bonding with your pup.
          </h4>
          <h4>
            <strong><em>About me: </em></strong>I have more than a decade of professional animal care, management, and training experience. I follow positive reinforcement principles, have a deep understanding of behavior and psychology principles, and know what makes a training plan effective and beneficial. 
          </h4>
        </div>
    </main>
  )
